...
public class UpdateServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		for (Question question : list) {
			newQuestionTitle = request.getParameter(question.getQueid());
			try {
				AdmService.ChangeQuestion(question.getQueid(), newQuestionTitle);
				request.getRequestDispatcher("/QuestionSystem/PostTestServlet").forward(request, response);
				//return;		// ∑¿÷πCannot forward after response has been committed
			} catch (Exception e) {
